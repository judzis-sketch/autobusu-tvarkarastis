...
import { Clock, Loader2, MapPin, List, ArrowRight } from 'lucide-react';
...
export default function TimetableClient() {
  ...
  const handleStopClick = (stop: TimetableEntry, index: number) => {
    if (!timetable || index >= timetable.length - 1) {
